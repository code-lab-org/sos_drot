"""
Resolution analysis using SNODAS SWE data for SOS_DROT.
...
file_name_preprocessed_SAR = "preprocessed_resolution_SAR.nc"
...
for date in dates:
    ...
    if (snodas_dir / f"{file_label}.nc").exists():
...
print("resolution before coarsening", ds.rio.shape, ds.rio.resolution(),ds.rio.height, ds.rio.width)
...
print("resolution after coarsening", ds_5km.rio.shape, ds_5km.rio.resolution(),ds_5km.rio.height, ds_5km.rio.width)
